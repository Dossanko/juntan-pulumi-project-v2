...
topic_id = os.environ.get('JAPAN_PPI_TOPIC_ID')

def get_japan_ppi_data():
    """
    FRED API から日本の PPI データを取得し、Pub/Sub に送信する関数
    """
    # FRED API のエンドポイント URL を設定します
    url = f"https://api.stlouisfed.org/fred/series/observations?series_id=JPNPPICMMINMEI&api_key={api_key}&file_type=json"
    ...
    try:
        ...
        print("日本 PPI データを Pub/Sub に送信しました。")
