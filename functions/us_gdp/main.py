...
topic_id = os.environ.get('US_GDP_TOPIC_ID')

def get_us_gdp_data():
    """
    FRED API から米国 GDP データを取得し、Pub/Sub に送信する関数
    """
    ...
    try:
        ...
        print("米国 GDP データを Pub/Sub に送信しました。")
...
def main(request):
    ...
    job_id = "get_us_gdp_job"
    schedule = "0 0 1 */3 *"  # 3ヶ月ごとに1日の0時0分に実行
