...
topic_id = os.environ.get('JAPAN_CPI_TOPIC_ID')

def get_japan_cpi_data():
    """
    FRED API から日本の CPI データを取得し、Pub/Sub に送信する関数
    """
    # FRED API のエンドポイント URL を設定します
    url = f"https://api.stlouisfed.org/fred/series/observations?series_id=JPNCPIALLMINMEI&api_key={api_key}&file_type=json"
    ...
    try:
        ...
        print("日本 CPI データを Pub/Sub に送信しました。")
