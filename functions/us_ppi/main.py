...
topic_id = os.environ.get('US_PPI_TOPIC_ID')

def get_us_ppi_data():
    """
    FRED API から米国 PPI データを取得し、Pub/Sub に送信する関数
    """
    # FRED API のエンドポイント URL を設定します
    url = f"https://api.stlouisfed.org/fred/series/observations?series_id=PPIACO&api_key={api_key}&file_type=json"
    ...
    try:
        ...
        print("米国 PPI データを Pub/Sub に送信しました。")
...
def main(request):
    ...
    job_id = "get_us_ppi_job"
    schedule = "0 0 25 * *"  # 毎月25日の0時0分に実行
