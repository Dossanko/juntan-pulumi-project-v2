...
topic_id = os.environ.get('US_CPI_TOPIC_ID')

def get_us_cpi_data():
    """
    FRED API から米国 CPI データを取得し、Pub/Sub に送信する関数
    """
    ...
    try:
        ...
        print("米国 CPI データを Pub/Sub に送信しました。")
...
def main(request):
    ...
    job_id = "get_us_cpi_job"
    schedule = "0 0 20 * *"  # 毎月20日の0時0分に実行
