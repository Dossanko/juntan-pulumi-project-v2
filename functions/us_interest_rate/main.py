...
topic_id = os.environ.get('US_INTEREST_RATE_TOPIC_ID')

def get_us_interest_rate_data():
    """
    FRED API から米国金利データを取得し、Pub/Sub に送信する関数
    """
    ...
    try:
        ...
        print("米国金利データを Pub/Sub に送信しました。")
...
def main(request):
    # 最初の実行時にデータを取得
    get_us_interest_rate_data()

    # Cloud Scheduler にジョブを作成
    job_id = "get_us_interest_rate_job"
