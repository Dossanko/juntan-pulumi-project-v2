...
topic_id = os.environ.get('JAPAN_GDP_TOPIC_ID')

def get_japan_gdp_data():
    """
    Alpha Vantage API から日本 GDP データを取得し、Pub/Sub に送信する関数
    """
    ...
    try:
        ...
        print("日本 GDP データを Pub/Sub に送信しました。")
...
def main(request):
    ...
    job_id = "get_japan_gdp_job"
    schedule = "0 0 1 1-12/3 *"  # 3ヶ月ごとに1日の0時0分に実行
