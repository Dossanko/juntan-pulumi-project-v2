...
topic_id = os.environ.get('US_PMI_TOPIC_ID')

def get_us_pmi_data():
    """
    FRED API から米国 PMI データを取得し、Pub/Sub に送信する関数
    """
    # FRED API のエンドポイント URL を設定します
    url = f"https://api.stlouisfed.org/fred/series/observations?series_id=ISMPMI&api_key={api_key}&file_type=json"
    ...
    try:
        ...
        print("米国 PMI データを Pub/Sub に送信しました。")
